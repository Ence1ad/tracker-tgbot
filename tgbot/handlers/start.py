...
from db.user import NewUser
from db.db_commands import create_user, check_user_in_db
from config import bot
from tgbot.keyboards.inline_kb import start_kb
...
async def start(event: NewMessage.Event):
    ...
    if isinstance(user_id, PeerUser):
        ...
        # Get keyboard
        inline_keyboard: ReplyInlineMarkup = start_kb()
