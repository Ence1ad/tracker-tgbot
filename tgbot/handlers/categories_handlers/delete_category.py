...
from cache.redis_tracker_commands import redis_delete_tracker, is_redis_hexists_tracker
...
async def get_del_categories(call: CallbackQuery, db_session: async_sessionmaker[AsyncSession],
...
async def del_category(call: CallbackQuery, callback_data: CategoryCD, db_session: async_sessionmaker[AsyncSession],
    ...
    await is_redis_hexists_tracker(user_id, redis_client) and await redis_delete_tracker(user_id, redis_client)
