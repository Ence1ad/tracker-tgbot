...
def register_actions_handlers() -> Router:
    ...
    It registers handlers for:
        ...
        - creating/updating/deleting an action with a given name and category id
        (category_id is passed in as callback data);

    :return: A router object

    """
    from .delete_actions import delete_action_handler
    from .read_actions import actions_main_menu_handler, display_actions, collect_actions_data_handler
