...
async def get_actions_options(call: CallbackQuery, callback_data: CategoryCD, state: FSMContext) -> None:
    ...
    markup = await menu_inline_kb(await ActionsButtons.action_menu_buttons())
...
async def display_actions(call: CallbackQuery, state: FSMContext, db_session: async_sessionmaker[AsyncSession]) -> None:
