...
async def get_tracker_options(call: CallbackQuery, redis_client: Redis, buttons: AppButtons) -> None:
...
async def no_btn_handler(call: CallbackQuery, buttons: AppButtons) -> None:
    markup = await menu_inline_kb(await buttons.tracker_menu_stop())
