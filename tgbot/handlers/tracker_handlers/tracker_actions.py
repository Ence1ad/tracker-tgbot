...
from db.actions.actions_db_commands import select_actions_for_tracker
...
async def show_user_actions_tracker(call: CallbackQuery) -> ScalarResult:
    ...
    actions: ScalarResult = await select_actions_for_tracker(user_id, category_name=category_name)
    return actions
