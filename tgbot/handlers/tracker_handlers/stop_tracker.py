...
from db.tracker.tracker_db_command import update_tracker, get_user_tracker, get_launch_tracker
from db.tracker.tracker_model import Tracker
from tgbot.utils.answer_text import traker_text, stop_tracker, not_launched_tracker_text
...
async def stop_tracker_handler(call: CallbackQuery):
    ...
    if tracker:
        ...
        await call.message.answer(text=stop_tracker + track_text)
    else:
