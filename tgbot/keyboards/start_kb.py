...
from tgbot.keyboards.buttons_names import actions_btn, categories_btn, reports_btn, \
    select_actions_btn, trackers_btn
...
async def start_custom_kb() -> InlineKeyboardMarkup:
    ...
    kb_builder.button(text=trackers_btn, callback_data=trackers_btn)
