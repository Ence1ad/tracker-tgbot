...
async def db_category_factory(
    ...
    """
    Create category records in the database associated with a user.
    ...
    async def _db_category_factory(user_id: int, category_name: str = CATEGORY_NAME
        ...
        """Create a category record associated with a user in the database.
...
async def add_data_to_db(db_user_factory, db_session_fixture, db_category_factory
    ...
    """Add initial data to the db, including users, categories, actions, and a tracker.
