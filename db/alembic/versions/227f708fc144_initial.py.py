...
Revision ID: 227f708fc144
Revises:
Create Date: 2023-10-20 23:02:40.945570
...
def upgrade() -> None:
    ...
    sa.Column('action_id', sa.Integer(), sa.Identity(always=False), nullable=False),
    ...
    sa.Column('tracker_id', sa.Integer(), sa.Identity(always=False), nullable=False),
    ...
    op.create_index('trackers_user_id_tracker_id_idx', 'trackers', ['user_id', 'tracker_id'], unique=False)
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('trackers_user_id_tracker_id_idx', table_name='trackers')
